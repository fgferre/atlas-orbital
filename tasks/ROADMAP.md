...
revealing T6 mesh invisibility). Estimate **M1-M5+M7 core
~8-13h, M6 forward-port ~14h (parallelizable post-M2.5),
Round-6 interactive flight ~10-14h** (active 2026-05-06,
promoted from CONTINGENT after Codex audit demonstrated
round-5's lerp-with-factor=60 cannot resolve U-1 jump
perception by any factor choice). Codex audit per milestone
