...
interface redesign with fresh eyes. Waves 1 and 2 are done; Wave 3 is
partial (sidebar order done, context line + rail hoist open); Wave 4 is
untouched. Read that file for the evidence base, the guardrail, the rail
root cause, and the list of claims already checked and rejected.
